...
const fp = "src/content/blog/cv-tips/2025-cv-format-that-wins-interviews-in-kenya.md";
...
const data = {
  ...
  draft: false,
  canonical: SITE + "/blog/cv-tips/2025-cv-format-that-wins-interviews-in-kenya",
  ...
  sources: [
    { label: "World Bank Kenya Economic Update", url: "https://www.worldbank.org/en/country/kenya/publication/kenya-economic-update-keu" },
    { label: "Kenya Labour Market Profile 2024/2025", url: "https://www.ulandssekretariatet.dk/wp-content/uploads/2024/09/Kenya-LMP-2024-final1.pdf" },
  ],
};
